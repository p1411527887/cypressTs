export class SpecialsPageUI {
    static readonly DYNAMIC_SPECIAL_PRODUCT = (itemName: string) =>
        `//span[text()='${itemName}']/ancestor::div[@class='item  special-item']`


    static readonly ADD_TO_CART_BUTTON = (itemName: string) =>
        `//span[contains(text(),'${itemName}')]/ancestor::div[@class='product-data-wrap']/following-sibling::div//button[@class='no-design add-to-cart aria-show-focus']`
